...
export const ReportService = {
  ...
  async getComparative(
    ...
    return unstable_cache(
      async () => {
        console.log("🔴 CACHE MISS — foi ao banco! [getComparative]");
              ...
              return {
                ...
                metrics: {
                  ...
                  gcAttendance: {
                    ...
                    comparative:
                      Math.round((currentPresenceGC - prevPresenceGC) * 100) /
                      100,
                  },
                  serviceAttendance: {
                    ...
                    comparative:
                      Math.round(
                        (currentPresenceCults - prevPresenceCults) * 100,
                      ) / 100,
                  },
                  serving: {
