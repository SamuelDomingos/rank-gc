        ...
        <div className="flex-1 space-y-4">
          <div>
            ...
            <span className="text-3xl font-extrabold text-primary">
              {dados?.points ?? 0} pontos
            </span>
          </div>
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
                <b className="text-foreground">Membros:</b>{" "}
                {dados?.quantityMembers ?? 0}
              </span>
            </div>
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
            ...
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
                <b className="text-foreground">Visitantes:</b>{" "}
                {dados?.visitors ?? 0}
              </span>
            </div>
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
                <b className="text-foreground">Presença GC:</b>{" "}
                {dados?.presenceGC ?? 0}%
              </span>
            </div>
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
                <b className="text-foreground">Presença Cultos:</b>{" "}
                {dados?.presenceCults ?? 0}%
              </span>
            </div>
            <div className="space-y-1">
              <span className="text-sm text-muted-foreground block">
                <b className="text-foreground">Servindo:</b>{" "}
                {dados?.serving ?? 0}%
              </span>
            </div>
          </div>
