...
import { AlertDialog, AlertDialogContent, AlertDialogAction, AlertDialogCancel, AlertDialogFooter, AlertDialogHeader, AlertDialogDescription, AlertDialogTrigger, AlertDialogTitle, } from "@/components/ui/alert-dialog"
                            ...
                            <CardHeader className="pb-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <div className={`flex items-center justify-center w-6 h-6 rounded-full font-semibold text-xs ${isTopThree
                            ...
                            <CardContent className="pb-3">
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-xs"><b>Membros:</b> {gc.quantity}</span>
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="sm:max-w-[480px]">
                                            <Tabs defaultValue="registerDayForm">
                                                <TabsList>
                                                    <TabsTrigger value="registerDayForm">Formulario</TabsTrigger>
                                                ...
                                                <TabsContent value="registerDayForm">
                                                    <DialogHeader>
                                                        ...
                                                        <DialogDescription>
                                                            Preencha as informações do grupo de conexão. Você poderá alterar esses dados depois.
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                ...
                                                <TabsContent value="listRegisters">
                                                    <DialogHeader>
                                                        <DialogTitle>Registros do mes de {month}</DialogTitle>
                                                        <DialogDescription>
                                                            Preencha as informações do grupo de conexão. Você poderá alterar esses dados depois.
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogDescription>
                                                            Esta ação não pode ser desfeita. Você realmente deseja deletar este gc?
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => fetchDelGc(gc.id)}>Excluir</AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
                                            </AlertDialog>
                                        </DropdownMenuContent>
